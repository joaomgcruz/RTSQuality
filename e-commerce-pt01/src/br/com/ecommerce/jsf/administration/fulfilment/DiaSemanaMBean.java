...
@Component
@Scope("request")
public class DiaSemanaMBean extends CadastroAbstractController<IntervaloServico>{
	...
	public List<SelectItem> getAllCombo() throws DAOException{
		return toSelectItems(getGenericDAO().findAll(DiaSemana.class,"id"), "id", "denominacao");
	}
